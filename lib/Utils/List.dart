...
List Motivation = [];
List<Map<String, String>> motivationList = [
  {
...
List<Map<String, String>> inspirationList = [
  {
...
List<Map<String, String>> loveQuotesList = [
  {
...
List<Map<String, String>> reflectionQuotesList = [
...
List<Map<String, String>> encouragementQuotesList = [
  {
    'quote': 'Believe you can and you\'re halfway there.',
    'author': 'Theodore Roosevelt'
  },
...
List<Map<String, String>> anxietyQuotesList = [
  {
    'quote':
...
List<Map<String, String>> businessQuotesList = [
  {
...
List<Map<String, String>> overcomingQuotesList = [
  {
    'quote':
        'The only limit to our realization of tomorrow is our doubts of today.',
    'author': 'Franklin D. Roosevelt'
...
List<Map<String, String>> positivityQuotesList = [
  {
    'quote':
...
List<Map<String, String>> depressionQuotesList = [
  {
...
List<Map<String, String>> goodMorningQuotesList = [
  {
...
List<Map<String, String>> selfEsteemQuotesList = [
  {
    'quote':
...
List<Map<String, String>> shortQuotesList = [
  {
    'quote':
...
List<Map<String, String>> moveOnQuotesList = [
  {
    'quote':
...
List<Map<String, String>> phrasesList = [
  {'phrase': 'Actions speak louder than words.', 'author': 'Abraham Lincoln'},
  {
  ...
  {'phrase': 'Better late than never.', 'author': 'Geoffrey Chaucer'},
  {
    'phrase': 'Don\'t count your chickens before they hatch.',
    'author': 'Aesop'
  },
  {'phrase': 'Every cloud has a silver lining.', 'author': 'John Milton'},
  {'phrase': 'Fortune favors the bold.', 'author': 'Virgil'},
  {'phrase': 'Honesty is the best policy.', 'author': 'Benjamin Franklin'},
  {'phrase': 'Practice makes perfect.', 'author': 'Anonymous'},
  {'phrase': 'The early bird catches the worm.', 'author': 'William Camden'},
  {
    'phrase': 'The pen is mightier than the sword.',
    'author': 'Edward Bulwer-Lytton'
  },
  {'phrase': 'When in Rome, do as the Romans do.', 'author': 'Saint Ambrose'},
];
List<Map<String, String>> photoQuotesList = [
  {
    'quote':
...
List<Map<String, String>> statusQuotesList = [
  {
...
List<Map<String, String>> bhagavadGitaQuotesList = [
  {
...
List<Map<String, String>> animeAntagonistQuotesList = [
  {
    'quote': 'Humans are so much fun! They’re all so different!',
    'antagonist': 'Hisoka Morrow - Hunter x Hunter'
  },
  {
    'quote':
  ...
  },
  {
    ...
    'antagonist': 'Archer - Fate/stay night: Unlimited Blade Works'
  },
  {
    'quote':
        'Those who stand at the top determine what’s wrong and what’s right! This very place is neutral ground! Justice will prevail, you say? But of course it will! Whoever wins this war becomes justice!',
    'antagonist': 'Donquixote Doflamingo - One Piece'
  },
  {
    'quote':
    ...
    'antagonist': 'Light Yagami - Death Note'
  },
  {
    'quote':
    ...
    'antagonist': 'Emiya Kiritsugu - Fate/Zero'
  },
  {
    'quote':
  ...
  },
  {
    ...
    'antagonist': 'Uchiha Itachi - Naruto Shippuden'
  },
];
List<Map<String, String>> antagonistQuotesList = [
